-- config.lua v0.5.0-dev
Config = {}
Config.Debug = true  -- 開発中はtrue、本番ではfalse
Config.Version = '0.5.0-dev'
...
Config.Stretcher = {
    ...
    patientOffset = { x = 0.0, y = 0.0, z = 0.8 },
}

-- TK Ambulance統合設定
Config.TKIntegration = {
    enabled = true,
    useExports = true,  -- Export優先、StateBagフォールバック
}
